    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-[#86868B] mt-1">จัดการและติดตามงานผลิตทั้งหมด</p>
        </div>
      ...
      <Modal
        ...
        title="สร้างงานผลิตใหม่"
        size="lg"
      >
        <div className="p-4 space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800">
            💡 สำหรับงาน Walk-in หรือลูกค้าที่ไม่ผ่าน Order
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              <label className="block text-sm text-[#86868B] mb-1">รายละเอียดงาน *</label>
              <Input
                value={createForm.product_description}
                onChange={(e) => setCreateForm(f => ({ ...f, product_description: e.target.value }))}
                placeholder="เช่น เสื้อยืดสีดำ พิมพ์หน้า A4"
              />
            </div>
            ...
            <div>
              <label className="block text-sm text-[#86868B] mb-1">จำนวน</label>
              <QuantityInput
                min={1}
          ...
          <div className="flex gap-2 justify-end pt-4 border-t border-[#E8E8ED]">
            ...
            <Button onClick={handleCreate} disabled={mutationLoading}>
              {mutationLoading ? 'กำลังสร้าง...' : 'สร้างงาน'}
            </Button>
          </div>
      </div>
      </Modal>
