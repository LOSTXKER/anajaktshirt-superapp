...
CREATE POLICY "Allow all for authenticated users" ON production_jobs FOR ALL TO authenticated USING (true);
...
CREATE POLICY "Allow all for authenticated users" ON roles FOR ALL TO authenticated USING (true);
